...
[![Go Reference](https://pkg.go.dev/badge/github.com/Drieam/appsignal-client-go.svg)](https://pkg.go.dev/github.com/Drieam/appsignal-client-go)
...
```bash
go get github.com/Drieam/appsignal-client-go
```
...
import (
	...
	appsignal "github.com/Drieam/appsignal-client-go"
)
...
The full API reference, with a usage example for every method, lives on [pkg.go.dev](https://pkg.go.dev/github.com/Drieam/appsignal-client-go). The package documentation also covers authentication, pointing the client at a different host, swapping the HTTP client, and telling GraphQL errors apart from HTTP errors.
